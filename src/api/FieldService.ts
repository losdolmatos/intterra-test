import { Operation, OperationType, CultureType, Assessment } from './models';
...
export default class FieldService {
  private operations: Array<Operation> = [
    new Operation({
      ...
      culture: CultureType.WINTER_WHEAT,
    ...
    new Operation({
      ...
      type: OperationType.BOWLING,
      culture: CultureType.WINTER_WHEAT,
      date: { year: 2021, month: 11, day: 10 },
      area: 78.0,
      comment: null,
      assessment: null,
    }),
